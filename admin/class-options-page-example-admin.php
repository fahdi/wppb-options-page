 ...
 * @subpackage Options_Page_Example/admin
 */
 ...
 */
class Options_Page_Example_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Options_Page_Example_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Options_Page_Example_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/options-page-example-admin.css', [], $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/options-page-example-admin.js', [ 'jquery' ], $this->version, false );
	...
	public function add_plugin_admin_menu() {
		 ...
		 */
		add_submenu_page( 'plugins.php', 'Plugin settings page title', 'Admin area menu slug', 'manage_options', $this->plugin_name, [
				$this,
